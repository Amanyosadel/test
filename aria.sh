...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
       ...
       --disk-cache=32M --enable-rpc=true --follow-torrent=mem --force-save=true --http-accept-gzip=true \
       --max-connection-per-server=1 --max-concurrent-downloads=1 --max-file-not-found=0 --max-tries=1 \
